export default function Footer() {
  return (
    <footer className="bg-gray-900 text-white py-8 md:h-[400px]">
      ...
      <div className="w-full  mb-6 md:mb-0 text-center">
            <h3 className="text-xl md:text-5xl font-semibold mb-2">Viktor's Liquor</h3>
            <p>Providing premium spirits since 1975</p>
          </div>
        <div className="flex flex-wrap justify-center md:py-8 text-center">

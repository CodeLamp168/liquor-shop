...
export default function LandingPage() {
  return (
    <section id="home" className="min-h-screen flex flex-col sm:flex-row text-white bg-white">
      <div className="left-side w-full sm:w-[350px] min-h-[50vh] sm:min-h-screen bg-maincolor bg-opacity-95 relative  content-center">
        <motion.div   
          initial={{ opacity: 0, y: -50 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5 }}
          className="p-4 sm:p-6 md:p-8 flex flex-col justify-center  h-full"
        >
      ...
      <div className="right-side flex-1 min-h-[50vh] sm:min-h-screen bg-white relative flex flex-col items-center justify-between xl:flex-row xl:items-end p-4 sm:p-6 md:p-8 xl:p-10">
        <motion.div
          initial={{ opacity: 0, x: -50 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.5 }}
          className="text-black mb-8 xl:mb-8 w-full max-w-md xl:max-w-lg"
        >
        ...
        <motion.div
          ...
          className="w-full max-w-md xl:max-w-xl flex justify-center xl:justify-end"
        >
          <Image
            ...
            width={700}
            height={1000}
            className="w-full max-w-[350px] sm:max-w-[450px] lg:max-w-[550px] xl:max-w-none xl:h-full 2xl:w-auto object-contain xl:object-cover"
          />
        </motion.div>
      </div>
    </section>

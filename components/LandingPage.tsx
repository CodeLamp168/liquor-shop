...
export default function LandingPage() {
  return (
    ...
    <motion.div
      ...
      className="w-full sm:w-[350px] sm:min-h-[50vh] md:min-h-screen bg-black bg-opacity-95  relative"
    >
    ...
    <motion.div
      ...
      className="flex-1 sm:min-h-[50vh] md:min-h-screen bg-white relative"
    >
